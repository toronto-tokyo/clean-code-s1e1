...
var completedTasksHolder = document.querySelector(".todo__complited-list");//completed-tasks
...
var createNewTaskElement = function (taskString) {
    ...
    editInput.type = "text";
    editInput.className = "input task__edit-info";
...
var editTask = function () {
    ...
    var editInput = listItem.querySelector('.task__edit-info');
    ...
    editInput.classList.toggle("task__edit-info_active");
    label.classList.toggle("task__info_hidden");
};
...
var taskCompleted = function () {
    ...
    var listItem = this.parentNode;
    const label = listItem.querySelector('.task__info')
    completedTasksHolder.appendChild(listItem);
    label.classList.add('task__info_complited')
...
var taskIncomplete = function () {
    ...
    const label = listItem.querySelector('.task__info')
    incompleteTaskHolder.appendChild(listItem);
    label.classList.remove('task__info_complited')
    bindTaskEvents(listItem, taskCompleted);
}
